...
$data=array( 
          ...
          2 => array('id'=>'2','pid'=>0,'name'=>'一级栏目二','selected'=>'selected'), 
...
$tree->init($data);        // 数据格式请参考 tree方法上面的注释! 
$str = "<option value=\$id >\$spacer\$name</option>"; //这个是没有选中的写法 传入数组中 selected 值可选 
//$str = "<option value=\$id \$selected>\$spacer\$name</option>"; //如果需要选中 则使用这种写法，传入数组中必须有 selected 值才行  
