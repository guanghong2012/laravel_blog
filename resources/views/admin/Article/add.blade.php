    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" method="post" action="{{ url('newwebadmin/article') }}" role="form" >
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <select class="form-control" id="form-field-select-1" name="pid">
                                <option value='1' selected="selected"> 程序人生</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" id="title" placeholder="文章标题" class="col-xs-10 col-sm-5" value="{{ old('title') }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="click" id="form-field-4" placeholder="浏览次数" class="col-xs-10 col-sm-5" value="0" />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="keywords" id="form-field-6" placeholder="关键词" class="col-xs-10 col-sm-5" value="{{ old('keywords') }}" />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" style="width:50%;" name="description" id="form-field-7" placeholder="描述">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="content" style="width:900px;float:left;">
                            <script id="demo_full_toolbar" name="content" type="text/plain">{!!  old('content') ? old('content') : '填写文章内容' !!}</script>
                            <script type="text/javascript">
                                // 定义默认编辑器高度
