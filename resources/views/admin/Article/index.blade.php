                ...
                <div class="table-responsive">
                    ...
                    <div class="row" style="padding-top: 12px;padding-bottom: 12px;background-color: #eff3f8;margin-right: 0px;margin-left: 0px;">
                        <form name="search" action="" method="get">
                            ...
                            <div class="col-sm-3">
                                ...
                                <label>文章名称： <input type="text" name="name" value="" /></label>
                    ...
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" cellpadding=0 cellspacing=0 >
                        ...
                        <tr>
                            ...
                            <th width="80px"><a href="javascript:sortBy('id','1','index')" title="按照文章ID升序排列 ">文章ID</a></th>
                            <th><a href="javascript:sortBy('title','1','index')" title="按照文章标题升序排列 ">文章标题</a></th>
                            <th><a href="javascript:sortBy('cate_id','1','index')" title="按照文章分类    升序排列 ">文章分类    </a></th>
                            ...
                            <th><a href="javascript:sortBy('keywords','1','index')" title="按照文章关键字     升序排列 ">文章关键字     </a></th>

                            <th width="80px"><a href="javascript:sortBy('view','1','index')" title="按照浏览次数升序排列 ">浏览次数</a></th>
