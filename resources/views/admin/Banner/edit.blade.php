    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" method="post" action="{{ url('newwebadmin/banner/'.$banner->id) }}" role="form" >
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" id="form-field-1" placeholder="信息名称" class="col-xs-10 col-sm-5" value="{{ $banner->name }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="url" id="title" placeholder="链接地址" class="col-xs-10 col-sm-5" value="{{ $banner->url }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="none_border">
                                <input type="hidden"  id="id_images" name="images"  value="{{ $banner->images }}" /><!--图片保存目录-->
                                ...
                                @else
                                    <img src="{{ $banner->images }}" onclick="openimg('images')" style='display:inline-block; float:left; cursor:pointer; margin-left:10px; border:#ccc solid 1px; width:35px; height:35px;' id='img_images' /><!--图片缩略图-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="col-xs-10 col-sm-5" name="created_at" id="create_time" value="{{ $banner->created_at }}" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="sort" id="form-field-5" placeholder="排序" class="col-xs-10 col-sm-5" value="{{ $banner->sort }}" />
                        </div>
