    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" method="post" action="{{ url('newwebadmin/navigation') }}" role="form" >
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" id="form-field-1" placeholder="导航名称" class="col-xs-10 col-sm-5" value="{{ old('name') }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="url" id="title" placeholder="链接地址" class="col-xs-10 col-sm-5" value="{{ old('url') }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="model" id="model" placeholder="模块名称" class="col-xs-10 col-sm-5" value="{{ old('model') }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="radio">
                                <label>
                                    <input name="is_blank" type="radio" class="ace" value="0" checked />
                                    <span class="lbl"> 否</span>
                                </label>
                                <label>
                                    <input name="is_blank" type="radio" class="ace" value="1"  />
