        ...
        <div class="content-wrap">
            <div class="content">
                ...
                <article class="excerpt excerpt-1">
                    ...
                    <header><a class="cat" href="program">{{$category->name}}<i></i></a>
                    ...
                    <p class="meta">
                        ...
                        <span class="views"><i class="glyphicon glyphicon-eye-open"></i> 共{{ $value->click }}人围观</span> <a class="comment" href=""><i class="glyphicon glyphicon-comment"></i> {{ $value->total_comment }}个评论</a></p>
