...
<header class="header">
    <div class="top-bar container-fluid">
        <div class="actions">
            <a class="btn hidden-xs" href="mailto:someone@example.com"><i class="fa fa-paper-plane" aria-hidden="true"></i> 发邮件给我</a>
            <a class="btn" href="#"><i class="fa fa-download" aria-hidden="true"></i> 下载我的简历</a>
        </div><!--//actions-->
    ...
    <div class="intro">
        <div class="container text-center">
            <img class="profile-image" src="{{ asset('assets/images/profile-image.png') }}" alt="">
    ...
    <div class="contact-info">
        <div class="container text-center">
            <ul class="list-inline">
                <li class="email"><i class="fa fa-envelope"></i><a href="mailto:137084553@qq.com">137084553@qq.com</a></li>
                <li><i class="fa fa-phone"></i> <a href="tel:13533481813">13533481813</a></li>
...
<div class="wrapper container">
    <section id="experiences-section" class="experiences-section section">
        <h2 class="section-title">工作经历/Work Experiences</h2>
        <div class="timeline">
            <div class="item">
    ...
    <section id="eudcation-section" class="education-section section">
        <h2 class="section-title">教育经历/Education</h2>
        <div class="row">
    ...
    <section id="skills-section" class="skills-section section text-center">
        ...
        <div class="top-skills">
            <h3 class="subtitle">主要技能/Top Skills</h3>
            <div class="row">
                <div class="item col-xs-12 col-sm-4">
                    <div class="item-inner">
        ...
        <div class="other-skills">
            <h3 class="subtitle">其他技能/Other Skills</h3>
    ...
    <section id="testimonials-section" class="testimonials-section section">
        <h2 class="section-title">推荐语/Testimonials</h2>
    ...
    <section id="portfolio-section" class="portfolio-section section">
        <h2 class="section-title">项目集/Portfolio</h2>
        ...
        <div class="items-wrapper isotope row">
            <div class="item frontend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-1.jpg') }}" alt="" />
                    </figure>
            ...
            <div class="item backend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-2.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
            ...
            <div class="item backend frontend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-3.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
            ...
            <div class="item frontend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-4.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
            ...
            <div class="item backend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-5.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
            ...
            <div class="item backend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-6.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
            ...
            <div class="item frontend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-7.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
            ...
            <div class="item frontend backend col-md-3 col-xs-6 ">
                <div class="item-inner">
                    <figure class="figure">
                        <img class="img-responsive" src="{{ asset('assets/images/portfolio/portfolio-8.jpg') }}" alt="" />
                    </figure>
                    <div class="content text-left">
                        <h3 class="sub-title"><a href="#">Project Lorem Ipsum</a></h3>
    ...
    <section id="contact-section" class="contact-section section">
        <h2 class="section-title">联系我/Get in Touch</h2>
        <div class="intro">
            <img class="profile-image" src="{{ asset('assets/images/profile-image.png') }}" alt="">
            <div class="dialog">
...
<footer class="footer text-center">
    <div class="container">
        <small class="copyright">Copyright &copy; 2016.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></small>
    </div><!--//container-->
</footer>

<!-- Javascript -->
<script type="text/javascript" src="{{ asset('assets/plugins/jquery-1.12.4.min.js') }}"></script>
