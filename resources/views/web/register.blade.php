...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/styles/bootstrap.default.min.css') }}">
...
<script type="text/javascript" src="{{asset('js/CanvasParticles-master/canvas-particle.js')}}"></script>
...
@if(@$page == "register")
    <div class="desk-front sign-flow clearfix sign-flow-simple">
        ...
        <div class="view view-signup selected" data-za-module="SignUpForm">
            <form class="zu-side-login-box" action="{{url('register')}}" id="sign-form-1" autocomplete="off" method="POST" novalidate="novalidate">
    ...
    @if(@$page == "login")
        <div class="desk-front sign-flow clearfix sign-flow-simple">
            ...
            <div class="view view-signup selected" data-za-module="SignUpForm">
                <form class="zu-side-login-box" action="{{url('login')}}" id="sign-form-1" autocomplete="off" method="POST" novalidate="novalidate">
                    <input type="password" hidden="">
                    <input type="hidden" name="_xsrf" value="6bdf63dbe265c4e922cab1002f9a923b">
                    <div class="group-inputs">
